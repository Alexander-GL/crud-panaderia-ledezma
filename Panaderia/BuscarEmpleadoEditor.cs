...
namespace Panaderia
{
    public partial class BuscarEmpleadoEditor : Form
    {
        public BuscarEmpleadoEditor()
        {
            InitializeComponent();
        }
        ...
        private void BuscarEmpleadoEditor_FormClosed(object sender, FormClosedEventArgs e)
        {

        }

        private void BuscarEmpleadoEditor_Load(object sender, EventArgs e)
        {
