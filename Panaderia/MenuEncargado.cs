...
namespace Panaderia
{
    public partial class MenuEncargado : Form
    {
        ...
        private void AbrirFormhijoDueño(object formhijoencargado)
        {
            if (this.panelContenedorEncargado.Controls.Count > 0)
                this.panelContenedorEncargado.Controls.RemoveAt(0);
            Form fh = formhijoencargado as Form;
            fh.TopLevel = false;
            fh.Dock = DockStyle.Fill;
            this.panelContenedorEncargado.Controls.Add(fh);
            this.panelContenedorEncargado.Tag = fh;
            fh.Show();
